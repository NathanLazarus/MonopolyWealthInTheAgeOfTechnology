...
setwd('C:/Users/Nathan/Downloads/Chapter7RDModel/NoOptimization/CondorUtilityComparison/Results/utilityComparison')
...
#
# PDVutilityPolicy = results[bestpolicy_by_PDVutility == T]
#
